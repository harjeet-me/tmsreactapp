...
/**
 * REST controller for managing {@link com.jiotms.tmsreactapp.domain.ProductItem}.
 */
@RestController
@RequestMapping("/api")
public class ProductItemResource {
    ...
    public ResponseEntity<ProductItem> updateProductItem(@RequestBody ProductItem productItem) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, productItem.getId().toString()))
            .body(result);
    }
