...
/**
 * REST controller for managing {@link com.jiotms.tmsreactapp.domain.Insurance}.
 */
@RestController
@RequestMapping("/api")
public class InsuranceResource {
    ...
    public List<Insurance> getAllInsurances(@RequestParam(required = false) String filter) {
        if ("carrier-is-null".equals(filter)) {
            log.debug("REST request to get all Insurances where carrier is null");
            return insuranceService.findAllWhereCarrierIsNull();
        }
